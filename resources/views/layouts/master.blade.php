                                                                    ...
                                                                    <div class="vertical-timeline-element-content bounce-in">
                                                                        <h4 class="timeline-title">Something not important
                                                                            <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                                ...
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/2.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                ...
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/4.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/5.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/9.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/7.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                                                                <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                    <div class="avatar-icon"><img
                                                                                                src="{{ asset('images/avatars/8.jpg') }}"
                                                                                                alt=""></div>
                                                                                </div>
                                ...
                                <!--<li class="theme-settings-swatches d-none list-group-item">
                                    ...
                                    <div class="swatch-holder swatch-holder-img active">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/city1.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/city2.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/city3.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/city4.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/city5.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/abstract1.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/abstract2.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/abstract3.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/abstract4.jpg') }}">
                                        </a>
                                    </div>
                                    <div class="swatch-holder swatch-holder-img">
                                        <a class="img-holder switch-trigger">
                                            <img alt=" " src="{{ asset('images/sidebar/abstract5.jpg') }}">
                                        </a>
                                    </div>
                                </li>-->
                            </ul>
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left mr-3">
                                                                    <div class="widget-content-left">
                                                                        <img width="42" class="rounded" src="{{ asset('images/avatars/1.jpg') }}" alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="widget-content-left">
