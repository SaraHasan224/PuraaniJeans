...
@section('page_title',env('APP_NAME').' - PIM')

@section('parent_module_icon','lnr-link')
...
@section('sub_child_module_breadcrumb_title','Product Inventory Management')

@section('content')
    {{--<!-- FILTERS VIEW STARTS HERE -->--}}
    @include('closet.pim.filters')
